...
class TestRolesView(TestCase):
    def setUp(self):
        ...
        self.eg_user = CustomUser.objects.create_user(
            email="test@parham.in",
            first_name="Test",
            last_name="User",
            level="AD",
            password="Test1234",
    ...
    def test_add_role_to_user(self):
        ...
        user_eg = CustomUser.objects.create_user(
            first_name="pr", last_name="la", email="a@p.com", level="AD", password=123
        )
        role_eg = Role.objects.create(
            id=1,
            name="can_view_data",
            module="Movie",
            kind="View",
