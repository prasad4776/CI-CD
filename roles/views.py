...
from .serializers import (RoleFilterSerializer, RoleSerializer,
                          RoleSerializerForListingUsers)
...
def listing_privileges_bestowed_on_a_role(request):
    ...
    return Response(
        {"roles with permissions": serializer.data}, status=status.HTTP_200_OK
    )
